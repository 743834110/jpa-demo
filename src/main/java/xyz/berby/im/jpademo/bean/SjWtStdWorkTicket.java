...
@Entity
@Table(name = "SJ_WT_STD_WORK_TICKET", schema = "TICKET", catalog = "")
public class SjWtStdWorkTicket {
    private String stdWorkTicketId;
    ...
    @Id
    @Column(name = "STD_WORK_TICKET_ID", nullable = false, length = 32)
    public String getStdWorkTicketId() {
        return stdWorkTicketId;
    }

    public void setStdWorkTicketId(String stdWorkTicketId) {
        this.stdWorkTicketId = stdWorkTicketId;
    }
    ...
    public boolean equals(Object o) {
        ...
        SjWtStdWorkTicket that = (SjWtStdWorkTicket) o;
        return Objects.equals(stdWorkTicketId, that.stdWorkTicketId) &&
