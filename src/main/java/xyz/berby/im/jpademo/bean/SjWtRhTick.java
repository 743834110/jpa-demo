...
@Entity
@Table(name = "SJ_WT_RH_TICK", schema = "TICKET", catalog = "")
public class SjWtRhTick {
    private String rhTicketId;
    ...
    @Id
    @Column(name = "RH_TICKET_ID", nullable = false, length = 32)
    public String getRhTicketId() {
        return rhTicketId;
    }

    public void setRhTicketId(String rhTicketId) {
        this.rhTicketId = rhTicketId;
    }
    ...
    public boolean equals(Object o) {
        ...
        SjWtRhTick that = (SjWtRhTick) o;
        return Objects.equals(rhTicketId, that.rhTicketId) &&
    ...
    @Override
    public int hashCode() {
        return Objects.hash(rhTicketId, workTicketId, keyBoxId, orgId, subOrgId, deptId, createPerson, createTime, modifyPerson, modifyTime, projectid);
    }
}
