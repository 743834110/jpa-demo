...
@Entity
@Table(name = "SJ_WT_BOX_MEASURE", schema = "TICKET", catalog = "")
public class SjWtBoxMeasure {
    ...
    @Basic
    @Column(name = "BOXTYPE", nullable = true, length = 30)
    ...
    public boolean equals(Object o) {
        ...
        SjWtBoxMeasure that = (SjWtBoxMeasure) o;
